...
mup_popt,_ = curve_fit(power_law, ns, mup, p0=[2.0, 0.10, 1.8], bounds=bounds, maxfev=20000)

print(f"SP: a={sp_popt[0]:.2f} alpha={sp_popt[1]:.4f} c={sp_popt[2]:.2f}")
print(f"muP: a={mup_popt[0]:.2f} alpha={mup_popt[1]:.4f} c={mup_popt[2]:.2f}")
t = 880_000_000
print(f"Extrap SP: {power_law(t, *sp_popt):.4f}")
print(f"Extrap muP: {power_law(t, *mup_popt):.4f}")
